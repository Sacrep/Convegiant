...
namespace Convegiant.Api.Spec
{
    ...
    public partial class ConvegiantApiClient 
    {
        ...
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<RecipeListItem>> RecipesAllAsync(int page)
        {
            return RecipesAllAsync(page, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<RecipeListItem>> RecipesAllAsync(int page, System.Threading.CancellationToken cancellationToken)
        {
            if (page == null)
